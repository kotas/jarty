...
Functions.register("assign", (runtime:RuntimeContext, params:TagParameters):void => {
    if (!params['var']) {
...
Functions.register("capture", (runtime:RuntimeContext, params:TagParameters):void => {
...
Functions.register("math", (runtime:RuntimeContext, params:TagParameters):void => {
    if (!params['equation']) {
...
Functions.register("counter", (runtime:RuntimeContext, params:TagParameters):void => {
